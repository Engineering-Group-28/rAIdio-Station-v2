    ...
    <main>
        <div class="topbanner">
            <div class="infocontainer">
                <img src="/engineering_radio.png" style="height: 15.0rem; border-radius: 0.5rem; padding-right: 0;">
                <p>
                    ...
                    <br>
                    <button
                      @click="togglePlayPause('/FAUEngineeringRadio_Combined.mp3', 'engineering', 'Engineering News Radio')"
                      class="button button1"
                    >
                      {{
                        audioPlayer.isPlaying && currentTrack == '/FAUEngineeringRadio_Combined.mp3'
                          ? 'Pause'
                          : 'Play'
                      }}
                    </button>
