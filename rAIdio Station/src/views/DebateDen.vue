    ...
    <main>
        <div class="topbanner">
            <div class="infocontainer">
                <img src="/debate_den_2.png" style="height: 15.0rem; border-radius: 0.5rem; padding-right: 0;"></img>
                <p>
                    ...
                    <br>
                     <button @click="togglePlayPause('/ResearchScript2_11_16.mp3', 'research', 'RISING RESEARCH: Episode 2')" class="button button1">
                        {{ audioPlayer.isPlaying  && currentTrack == '/ResearchScript2_11_16.mp3' ? 'Pause' : ' ▶︎ Play Recent' }}
                    </button>
