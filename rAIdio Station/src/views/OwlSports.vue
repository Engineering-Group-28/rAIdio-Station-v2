...
audioPlayer.currentTitle = "Owl Sports";
audioPlayer.currentImage = "/owl_sports.png";
    ...
    <main>
        <div class="topbanner">
            <div class="infocontainer">
                <img src="/owl_sports.png" style="height: 15.0rem; border-radius: 0.5rem; padding-right: 0;"></img>
                <p>
                    ...
                    <br>
                     <button @click="togglePlayPause('/FAUSportsRadio_Combined.mp3', 'engineering', 'Owl Sports Radio')" class="button button1">
                        {{ audioPlayer.isPlaying && currentTrack == '/FAUSportsRadio_Combined.mp3' ? 'Pause' : 'Play' }}
                    </button>
